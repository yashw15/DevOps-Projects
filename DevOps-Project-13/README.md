...
> *If you'd like to skip straight to the download of the example pipeline and Terraform code, it can be found on* [*GitHub*](https://github.com/yashw15487/DevOps-Projects/tree/master/DevOps-Project-20/terraform)*.*
