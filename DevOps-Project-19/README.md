...
**GITHUB REPO**: [Chatbot-UI](https://github.com/yashw15487/DevOps-Projects/tree/master/DevOps-Project-28/Chatbot-UI)

```
git clone https://github.com/yashw15487/DevOps-Projects/DevOps-Project-28/Chatbot-UI
...
pipeline{
    ...
    stages {
        stage('Checkout from Git'){
            steps{
                git branch: 'master', url: 'https://github.com/yashw15487/DevOps-Project-28/Chatbot-UI.git'
            }
        }
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag chatbot DevOps with yashwTech/chatbot:latest "
                       sh "docker push DevOps with yashwTech/chatbot:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image DevOps with yashwTech/chatbot:latest > trivy.json" 
            }
        }
