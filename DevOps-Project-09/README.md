...
[Deploy Two-Tier Architecture on AWS using Terraform](https://blog.DevOps with yashw.xyz/deploy-two-tier-architecture-on-aws-using-terraform)  
...
```bash
git clone https://github.com/yashw15/DevOps-Projects
